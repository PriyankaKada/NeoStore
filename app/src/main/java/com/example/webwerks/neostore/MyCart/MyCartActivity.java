...
import com.example.webwerks.neostore.ProductDetail.ProductImage;
import com.example.webwerks.neostore.ProductDetail.ProductImagesAdapter;
...
public class MyCartActivity extends AppCompatActivity implements CartView{
    ...
    public void setData(CartModel res) {
        ...
        List<Datum>   product_data = new ArrayList<>();
    ...
    private void setRecyclerView(List<Datum> product_data, CartModel res) {
        CartAdapter cartAdapter = new CartAdapter(getApplicationContext(), product_data, res,this);
